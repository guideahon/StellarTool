...
- **Movesets Fusion/Scarlet/Raven** analiza las variantes con granularidad de
  tabla, propiedad y asset desde `Build Stellar Tool Mod`; agrupa conflictos
...
selección segura de filas por regex; la pestaña Cambios y el CLI aceptan tanto
carpetas como archivos comprimidos `.stpatch`; no se ejecuta código embebido.
