...
| `UAssetGUI.exe` | https://github.com/atenfyr/UAssetGUI/releases (tag `experimental-latest`) | 1.1.1 experimental | tojson/fromjson de .uasset (`VER_UE4_26` + usmap); requiere **.NET 10 Desktop Runtime** en Windows (x64 recomendado). El SDK .NET 10 también lo incluye, pero no es necesario para usuarios. **La 1.1.0 estable NO sirve**: parsea las DataTables de Stellar Blade como RawExport. |
